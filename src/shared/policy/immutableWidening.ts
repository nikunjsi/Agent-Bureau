...
const EXEMPLARS: readonly Exemplar[] = [
  ...
  },
  {
    ...
    tool: 'Bash',
    toolClass: 'command',
    canonicalArg: 'git push',
    canonicalPath: null,
    describes: 'pushing to the default remote',
  },
  {
    ruleId: 'deny.git_write',
    tool: 'Bash',
    toolClass: 'command',
    canonicalArg: 'git -C . push',
    canonicalPath: null,
    describes: 'pushing from another directory',
  },
  {
    ruleId: 'deny.git_write',
    tool: 'Bash',
    toolClass: 'command',
    canonicalArg: 'git -C . push origin main',
    canonicalPath: null,
    describes: 'pushing a named branch from another directory',
  },
  {
    ruleId: 'deny.git_write',
    tool: 'Bash',
    toolClass: 'command',
    canonicalArg: 'git --git-dir=.git push',
    canonicalPath: null,
    describes: 'pushing with an explicit git directory',
  },
  {
    ruleId: 'deny.git_write',
    tool: 'Bash',
    toolClass: 'command',
    canonicalArg: 'git --git-dir=.git push origin main',
    canonicalPath: null,
    describes: 'pushing a named branch with an explicit git directory',
  },
  {
