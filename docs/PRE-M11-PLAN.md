...
| X-17 | §14.9, L2675 · §28 M9 item 7 | A pinned note in the memory list has an icon and a screen-reader-only label, so there's no **visible** label ("never colour alone", icon *and* label) | A visible "Pinned" label beside the icon in the list, with a renderer test asserting it | DONE <pending> |
