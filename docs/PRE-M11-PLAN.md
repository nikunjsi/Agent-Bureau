...
| D-2 | The shutdown sequence stops no Supervisor (none exist in production yet) | Supervisors are stopped in `runShutdownSequence` before the control channel drains, tested with a live FakeAdapter Supervisor | DONE <pending> |
